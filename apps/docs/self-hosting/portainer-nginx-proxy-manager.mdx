...
| --- | --- | --- | --- | --- |
| `send.exemplo.com` | `http` | `usesend_usesend` | `3000` | Websockets Support, Block Common Exploits, certificado Let's Encrypt e Force SSL |
| `storage.exemplo.com` | `http` | `usesend_minio` | `9000` | certificado Let's Encrypt e Force SSL |
