---
title: Go
description: "The Madmail Go package lets you interact with the Madmail API to send emails, manage contacts, and work with domains. This guide covers basic setup and usage."
icon: golang
---
...
If you are running a self-hosted version of Madmail, provide the base URL using `WithBaseURL`.
```go
...
Retrieve the contact book ID from the Madmail dashboard.
