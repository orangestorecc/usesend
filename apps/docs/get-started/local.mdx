...
description: "A guide on how to run Madmail’s codebase locally"
icon: code
---

## Introduction

Madmail's codebase is fully [open-source on github](https://github.com/usesend/usesend)
...
- `marketing`: The code for the landing page of Madmail
...
- `sdk` package contains TypeScript SDK for Madmail REST API
...
## Running Madmail locally

To run Madmail locally, you will need to setup the following:
...
Next, [create a new GitHub App](https://github.com/settings/applications/new). This will allow you to sign in to Madmail with your GitHub account.
