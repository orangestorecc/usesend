...
description: "A guide on how to use Madmail with React Email"
---

## Introduction

[React Email](https://react.email/docs/introduction) is a library for building emails with React. In this guide, we will show you how to use Madmail with React Email.
