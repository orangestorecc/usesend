export const metadata = {
  title: "September Outage Update | Madmail",
  description:
...
- **14:11** - Clarified our product offering again, noting we had blocked the account and paused signups. Shared the Madmail site, GitHub, etc.
...
The pause highlighted areas where we can be more diligent about what gets sent through Madmail and ensure alignment with SES guidelines and broader email standards.
...
- Considering a BYO SES option, with Madmail managing it for a flat fee.
