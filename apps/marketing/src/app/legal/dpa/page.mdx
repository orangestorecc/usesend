export const metadata = {
  title: "Acordo de Tratamento de Dados (DPA) — Madmail",
  description: "Acordo de Tratamento de Dados da Madmail nos termos da LGPD: papéis, suboperadores, segurança e incidentes.",
  alternates: { canonical: "https://www.madmail.com.br/legal/dpa" },
};
